...
latex_documents = [
    (master_doc, 'tekel.tex', 'tekel Documentation',
     'Romain R. Brault', 'manual'),
]
...
man_pages = [
    (master_doc, 'tekel', 'tekel Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'tekel', 'tekel Documentation',
     author, 'tekel', 'One line description of project.',
     'Miscellaneous'),
]
